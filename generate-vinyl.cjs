...
const musicFolder = path.join(__dirname, "music", "vinyl");
const coverFolder = path.join(__dirname, "covers", "vinyl");
const outputFile  = path.join(__dirname, "tracklists", "vinyl.json");
