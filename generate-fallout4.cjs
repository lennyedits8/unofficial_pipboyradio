...
const musicFolder = path.join(__dirname, "music", "fallout4");
const coverFolder = path.join(__dirname, "covers", "fallout4");
const outputFile  = path.join(__dirname, "tracklists", "fallout4.json");
...
// run node generate-fallout4.cjs